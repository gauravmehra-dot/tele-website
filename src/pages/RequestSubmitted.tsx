...
export default function RequestSubmitted({ setPage }: Props) {
  // Generated once per mount — computing this in the render body regenerated
  // the reference number on every re-render.
  const [refNum] = useState(() => 'TH-2026-' + Math.floor(10000 + Math.random() * 90000))

  const handleNav = (page: string) => setPage(page)
    ...
    <div className="min-h-screen bg-[#F5F9FF] pt-16 flex items-center">
      <div className="max-w-2xl mx-auto px-4 py-16 text-center w-full">
        ...
        <p className="text-[#64748B] text-lg mb-10">
          Thank you! A qualified Australian doctor will review your request shortly.
        </p>
        ...
        <div className="bg-white rounded-2xl border border-[#E2EBF6] p-6 mb-8 text-left">
          ...
          <div className="space-y-4">
            {[
              ...
              { step: '3', title: 'Your consultation', desc: 'Connect with your doctor via video or phone at your preferred time.', done: false },
            ].map((item) => (
